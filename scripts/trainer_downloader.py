...
from scripts import training_paths as train_paths
import json 
...
async def main():
    ...
    parser.add_argument(
        "--task-type",
        required=True,
        choices=[TaskType.IMAGETASK.value, TaskType.INSTRUCTTEXTTASK.value, TaskType.CHATTASK.value, TaskType.DPOTASK.value, TaskType.GRPOTASK.value],
    )
