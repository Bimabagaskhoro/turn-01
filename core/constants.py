...
REG_RATIO = float(os.getenv("REG_RATIO", "1.012"))
LR_AMPLIFY_RATE = float(os.getenv("LR_AMPLIFY_RATE", "1.051"))
FIND_LR = os.getenv("FIND_LR", "True").lower() in ("true", "1", "yes")

IS_PROXY = os.getenv("IS_PROXY", "False").lower() in ("true", "1", "yes")
NAME_IDENTITY = os.getenv("NAME_IDENTITY", "test")